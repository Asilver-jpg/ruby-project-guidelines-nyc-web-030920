...
update_movie("The Invisible Man", 125, 22914050, 84500000)
...
update_movie("Kamen Rider Zi-O NEXT TIME: Geiz, Majesty", 64, nil, nil)
update_movie("Sonic the Hedgehog", 99, 306766470, 85000000)
update_movie("Jumanji: The Next Level", 123, 796575993, 125000000)
update_movie("Frozen II", 103, 1450026933, 150000000)
...
update_movie("A Rainy Day in New York", 92, 20537678, nil)
update_movie("The Panti Sisters", 108, 2272, nil)